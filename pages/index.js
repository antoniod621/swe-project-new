        ...
        <Layout home>
            ...
            <section className={utilStyles.heading} style={{textAlign: 'center', padding: "10px"
                ...
                <p style={{textAlign: 'center', padding: "15px"
                    ...
                    <Link href="/posts/Other"><Button style={{ fontSize: 25 }} variant="outlined">
                    Other</Button></Link>
                </p>
                <p >
                    <Link href="/posts/inventory"><Button variant="outlined" startIcon={<Avatar src={'https://www.pngfind.com/pngs/m/577-5777332_png-file-svg-inventory-icon-png-transparent-png.png'} />}>
