        ...
        <Layout home>
            ...
            <section className={utilStyles.heading} style={{textAlign: 'center', padding: "10px"
                ...
                <p style={{textAlign: 'center'
                    ...
                    <Link href="/posts/Drive" passHref={true}><Button variant="outlined" startIcon={<Avatar src={'https://static.thenounproject.com/png/57367-200.png'} />}>
                    Drive</Button></Link>&nbsp;

                    <Link href="/posts/Electrical" passHref={true}><Button  variant="outlined" startIcon={<Avatar src={'https://banner2.cleanpng.com/20180329/wyw/kisspng-electricity-computer-icons-symbol-electricity-5abd333f208164.7077256515223488631332.jpg'} />}>
